...
public enum ErrorCode {
    ...
    LOCATION_SAVE_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "위치 정보 저장에 실패했습니다"),

    // ── Feed / Post ──
    POST_NOT_FOUND(HttpStatus.NOT_FOUND, "게시글을 찾을 수 없습니다"),
    REQUEST_NOT_FOUND(HttpStatus.NOT_FOUND, "공구 요청을 찾을 수 없습니다"),
    ALREADY_CLOSED(HttpStatus.BAD_REQUEST, "이미 마감된 공구입니다"),

    // ── IP Check ──
    IP_CHECK_FAILED(HttpStatus.INTERNAL_SERVER_ERROR, "IP 체크에 실패했습니다"),
    BLOCKED_NETWORK(HttpStatus.FORBIDDEN, "차단된 네트워크입니다"),
